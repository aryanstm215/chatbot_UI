...
if not st.session_state.chat_history:
    st.session_state.chat_history.append({"role": "bot", "content": "Hello! Welcome to the text translation chatbot. Please upload a PDF or enter the text you want to translate and select the target language."})
...
with st.form("user_input_form"):
    ...
    user_input = st.text_area("Or enter text:")
