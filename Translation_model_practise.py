...
def Translate_Text(user_text, target_language):
    ...
    **Target Language:**
    ...
    chain = LLMChain(
        llm=HuggingFaceHub(repo_id='mistralai/Mistral-7B-Instruct-v0.2', model_kwargs={'temperature':0.5 , 'max_new_tokens': 250}, huggingfacehub_api_token=api_token),
        prompt=prompt
    )
...
with st.form("user_input_form"):
    ...
    target_language = st.selectbox("Select target language", ["English", "Spanish", "French", "German", "Italian", "Chinese", "Japanese", "Russian"])
